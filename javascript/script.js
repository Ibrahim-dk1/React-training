...
const updatedBook = {
  ...book,
  moviePublicationDate: "2003-03-25",
  //overite the pages(update it)
  //pages: 1210,
};
updatedBook;
...
console.log(book.translations.spanish || "we are working on the translation");
...
console.log(getTotalRiview(book)); */
/*function getTotalRiview(book) {
...
const essentialData = books.map((book) => ({
  title: book.title,
  book: book.author,
  reviecount: getTotalRiview(book),
}));
essentialData;
